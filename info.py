...
# ============================
SESSION = environ.get('SESSION', 'Nobara💮')   # Session name for the bot
...
# ============================
CACHE_TIME = int(environ.get('CACHE_TIME', 255))    # Cache time in seconds (default: 5 minutes)
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/3vfesv.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://files.catbox.moe/3vfesv.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/s73ob5.webm")
SPELL_IMG = environ.get("SPELL_IMG", "https://files.catbox.moe/s73ob5.webm")
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002967191753")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sonujohnsonsilly3_db_user:zm0lZOmkxmh2nHH7@cluster0.lq1gpqj.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
