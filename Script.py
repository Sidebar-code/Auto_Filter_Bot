class script(object):
    START_TXT = """<b><u>💮Yo!Yo! Yokozo!</u></b>
...
📌 ꜰᴏʀ ꜱᴇʀɪᴇꜱ:  
➤ Anime Name + S01 (ꜰᴏʀ ꜱᴇᴀꜱᴏɴ 1, ᴄʜᴀɴɢᴇ ꜰᴏʀ ᴏᴛʜᴇʀꜱ)  
...
<b>😊 ɴᴏ ᴡᴏʀʀɪᴇꜱ — ᴄʜᴏᴏꜱᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ᴏɴᴇ ʙᴇʟᴏᴡ 👇</b
    ...
    DEL_MSG = "⚠️ This Anime file/VIDEO will be deleted in <b>⏳<code>180 seconds</code></b>"
...
⚜️ ᴇxᴀᴍᴘʟᴇ : Sakamoto Days 2025

📝 ꜱᴇʀɪᴇꜱ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ 👇

⚜️ ᴇxᴀᴍᴘʟᴇ : Blue Lock S01

🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)</b>"""
    
    I_CUD_NT = """<b>ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ or Anime ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}.
